    ...
    weeks: [
      { n: 1, title: "Python Setup & Core Syntax", sessions: [
        { label: "Study", focus: "Environment setup + data types", resources: [
          { type: "Docs",    item: "Python 3 Official Tutorial – Ch 3 'An Informal Introduction to Python'", where: "docs.python.org/3/tutorial/introduction.html — the cleanest intro exists", mins: 35 },
          { type: "YouTube", item: "Tech With Tim – 'Python for Beginners (Full Course)'", where: "YouTube → search 'Tech With Tim Python for beginners' — watch up to functions section", mins: 60 },
        ]},
        { label: "Study", focus: "Control flow, f-strings & string methods", resources: [
          { type: "Docs",    item: "Python 3 Tutorial – Ch 4 'More Control Flow Tools' (if, for, while, break/continue)", where: "docs.python.org/3/tutorial/controlflow.html", mins: 30 },
          { type: "Article", item: "Real Python – 'Python f-strings are awesome'", where: "realpython.com/python-f-strings/ — every string formatting trick you need", mins: 20 },
        ]},
      ...
      { n: 2, title: "Functions, Modules & Comprehensions", sessions: [
        { label: "Study", focus: "Functions — args, kwargs, scope, closures", resources: [
          { type: "Docs",    item: "Python 3 Tutorial – Ch 4 (Functions section) + Ch 6 'Modules'", where: "docs.python.org/3/tutorial/modules.html", mins: 35 },
          { type: "YouTube", item: "Corey Schafer – 'Python Functions' + 'Python Modules'", where: "YouTube → search 'Corey Schafer Python functions' — 2 videos, ~30 min each", mins: 50 },
        ]},
        { label: "Study", focus: "List/dict/set comprehensions & generators intro", resources: [
          { type: "Article", item: "Real Python – 'Python Comprehensions: A Step By Step Introduction'", where: "realpython.com/list-comprehension-python/", mins: 30 },
          { type: "YouTube", item: "Corey Schafer – 'Comprehensions in Python'", where: "YouTube → search 'Corey Schafer comprehensions Python'", mins: 20 },
        ]},
        { label: "Build", focus: "Modular CLI todo manager", resources: [
          { type: "Build",   item: "CLI todo manager split across modules: models.py (Task dataclass), storage.py (JSON file), cli.py (add/list/done/delete commands).", where: "Use argparse for CLI. Import between modules. Ask Claude to review module design!", mins: 75 },
        ]},
      ]},
      { n: 3, title: "OOP Fundamentals & Error Handling", sessions: [
        { label: "Study", focus: "Classes — __init__, attributes, methods, @property", resources: [
          { type: "Docs",    item: "Python 3 Tutorial – Ch 9 'Classes' (full chapter)", where: "docs.python.org/3/tutorial/classes.html", mins: 40 },
          { type: "YouTube", item: "Corey Schafer – 'Python OOP Tutorial' (6-part series)", where: "YouTube → search 'Corey Schafer Python OOP' — all 6 parts, ~1.5 hrs total", mins: 75 },
        ]},
        { label: "Study", focus: "Inheritance, polymorphism & custom exceptions", resources: [
          { type: "Article", item: "Real Python – 'Inheritance and Composition: A Python OOP Guide'", where: "realpython.com/inheritance-composition-python/", mins: 35 },
          { type: "Docs",    item: "Python 3 Tutorial – Ch 8 'Errors and Exceptions'", where: "docs.python.org/3/tutorial/errors.html — custom exception hierarchy", mins: 25 },
        ]},
      ...
      { n: 4, title: "Data Structures, Git & Python Ecosystem", sessions: [
        { label: "Study", focus: "Built-in data structures & Big-O basics", resources: [
          { type: "Article", item: "Real Python – 'Python's list, dict and set — time complexities'", where: "wiki.python.org/moin/TimeComplexity — print this out and memorise it", mins: 20 },
          { type: "YouTube", item: "CS Dojo – 'Introduction to Big O Notation'", where: "YouTube → search 'CS Dojo Big O notation introduction'", mins: 20 },
        ]},
        { label: "Study", focus: "Virtual environments, pip & Git basics", resources: [
          { type: "Docs",    item: "Python 3 Tutorial – Ch 12 'Virtual Environments and Packages' (venv + pip)", where: "docs.python.org/3/tutorial/venv.html — how every Python project should be set up", mins: 20 },
          { type: "YouTube", item: "Tech With Tim – 'Git and GitHub for Beginners'", where: "YouTube → search 'Tech With Tim Git GitHub beginners'", mins: 40 },
        ]},
    ...
    weeks: [
      { n: 5, title: "Dataclasses, ABCs & Protocols", sessions: [
        { label: "Study", focus: "Dataclasses — the modern Python class", resources: [
          { type: "Docs",    item: "Python docs – dataclasses (full module reference)", where: "docs.python.org/3/library/dataclasses.html — frozen, kw_only, __post_init__", mins: 30 },
          { type: "YouTube", item: "ArjanCodes – 'Python Dataclasses'", where: "YouTube → search 'arjan codes dataclasses'", mins: 20 },
        ]},
        { label: "Study", focus: "Abstract Base Classes & Protocols (structural typing)", resources: [
          { type: "Book",    item: "Fluent Python 2e – Ch 11 'A Pythonic Object'", where: "pp. 321–360 — ABCs, Protocols, duck typing vs goose typing", mins: 50 },
          { type: "YouTube", item: "ArjanCodes – 'ABCs vs Protocols in Python'", where: "YouTube → search 'arjan codes abc vs protocol python'", mins: 22 },
        ]},
      ...
      { n: 6, title: "Descriptors, __slots__ & Metaclasses", sessions: [
        { label: "Study", focus: "Descriptors — how Python properties really work", resources: [
          { type: "Book",    item: "Fluent Python 2e – Ch 23 'Attribute Descriptors'", where: "pp. 693–726 — the mechanism behind @property, @classmethod, @staticmethod", mins: 50 },
          { type: "YouTube", item: "ArjanCodes – 'Python Descriptors Explained'", where: "YouTube → search 'arjan codes python descriptors'", mins: 20 },
        ]},
        { label: "Study", focus: "__slots__ for memory efficiency & metaclasses intro", resources: [
          { type: "Book",    item: "Fluent Python 2e – Ch 24 'Class Metaprogramming'", where: "pp. 729–778 — __init_subclass__, metaclass basics, class decorators", mins: 55 },
          { type: "YouTube", item: "mCoding – 'Python Metaclasses'", where: "YouTube → search 'mCoding python metaclasses'", mins: 22 },
        ]},
      ...
      { n: 7, title: "Generators, Iterators & Context Managers", sessions: [
        { label: "Study", focus: "Generators and the iteration protocol", resources: [
          { type: "Book",    item: "Fluent Python 2e – Ch 17 'Iterators, Generators, and Classic Coroutines'", where: "pp. 525–586 — yield, yield from, generator expressions, infinite sequences", mins: 50 },
          { type: "YouTube", item: "ArjanCodes – 'Python Generators'", where: "YouTube → search 'arjan codes python generators'", mins: 18 },
        ]},
        { label: "Study", focus: "Context managers with __enter__/__exit__ and contextlib", resources: [
          { type: "Docs",    item: "Python contextlib — @contextmanager, suppress, redirect_stdout, ExitStack", where: "docs.python.org/3/library/contextlib.html", mins: 25 },
          { type: "YouTube", item: "mCoding – 'Context Managers in Python'", where: "YouTube → search 'mCoding context managers python'", mins: 18 },
        ]},
      ...
      { n: 8, title: "Asyncio & Type Hints", sessions: [
        { label: "Study", focus: "asyncio fundamentals — event loop, coroutines, tasks", resources: [
          { type: "Book",    item: "Fluent Python 2e – Ch 19 'Concurrency Models in Python'", where: "pp. 615–670 — threads vs processes vs asyncio, when to use each", mins: 55 },
          { type: "YouTube", item: "ArjanCodes – 'AsyncIO in Python'", where: "YouTube → search 'arjan codes asyncio python'", mins: 30 },
        ]},
        { label: "Study", focus: "Type hints — generics, TypeVar, Protocol, Literal", resources: [
          { type: "Docs",    item: "Python typing module — TypeVar, Generic, Protocol, Literal, TypedDict, Final", where: "docs.python.org/3/library/typing.html — especially Protocols and TypeVars", mins: 35 },
          { type: "YouTube", item: "ArjanCodes – 'Python Type Hints'", where: "YouTube → search 'arjan codes python type hints'", mins: 20 },
        ]},
        { label: "Build", focus: "Async web scraper with typed interfaces", resources: [
          { type: "Build",   item: "Async scraper: asyncio + aiohttp, fetches 10 URLs concurrently, Protocol-typed scraper/storage, full type hints (strict mypy). 10× faster than sync.", where: "Benchmark sync vs async. Ask Claude: 'asyncio.gather vs asyncio.TaskGroup?'", mins: 75 },
        ]},
      ]},
      { n: 9, title: "Functional Python — functools & itertools", sessions: [
        { label: "Study", focus: "functools — lru_cache, partial, reduce, wraps", resources: [
          { type: "Docs",    item: "Python functools module — full reference (lru_cache, cache, partial, reduce, total_ordering)", where: "docs.python.org/3/library/functools.html", mins: 30 },
          { type: "YouTube", item: "mCoding – 'Python functools (full tour)'", where: "YouTube → search 'mCoding functools python'", mins: 25 },
        ]},
        { label: "Study", focus: "itertools — the Swiss army knife for lazy sequences", resources: [
          { type: "Docs",    item: "Python itertools — chain, islice, groupby, product, combinations, permutations, accumulate", where: "docs.python.org/3/library/itertools.html — every senior Python dev knows these", mins: 30 },
          { type: "Article", item: "Real Python – 'Itertools in Python 3 by Example'", where: "realpython.com/python-itertools/", mins: 25 },
        ]},
      ...
      { n: 10, title: "Python Concurrency Deep Dive", sessions: [
        { label: "Study", focus: "GIL, threading & multiprocessing — when each wins", resources: [
          { type: "Book",    item: "Fluent Python 2e – Ch 19 'Concurrency Models' (threading + multiprocessing sections)", where: "pp. 615–670 — CPU-bound vs I/O-bound. The GIL explained clearly.", mins: 55 },
          { type: "YouTube", item: "mCoding – 'Python GIL Explained'", where: "YouTube → search 'mCoding Python GIL'", mins: 20 },
        ]},
        { label: "Study", focus: "concurrent.futures & asyncio patterns", resources: [
          { type: "Docs",    item: "Python concurrent.futures — ThreadPoolExecutor, ProcessPoolExecutor, Future, as_completed", where: "docs.python.org/3/library/concurrent.futures.html", mins: 30 },
          { type: "YouTube", item: "ArjanCodes – 'Python Concurrency Best Practices'", where: "YouTube → search 'arjan codes python concurrency'", mins: 25 },
        ]},
        { label: "Build", focus: "Concurrent image processor + benchmark", resources: [
          { type: "Build",   item: "Process 100 images: sequential → ThreadPool (I/O) → ProcessPool (CPU resize). Benchmark all 3. Use asyncio for concurrent downloads.", where: "Print timing table. Ask Claude: 'Why does threading help for I/O but not CPU?'", mins: 75 },
        ]},
      ]},
    ],
  },
    ...
    weeks: [
      { n: 11, title: "SOLID Principles", sessions: [
        { label: "Study", focus: "SRP, OCP & LSP principles", resources: [
          { type: "Article", item: "refactoring.guru – SOLID in Python (all 5 sections)", where: "refactoring.guru/solid — Python examples throughout. Read SRP + OCP + LSP first.", mins: 40 },
          { type: "YouTube", item: "ArjanCodes – 'SOLID Design Principles' series", where: "YouTube → search 'arjan codes solid design principles'", mins: 30 },
        ]},
        { label: "Study", focus: "ISP & DIP — interface segregation and dependency inversion", resources: [
          { type: "Article", item: "refactoring.guru – ISP + DIP in Python", where: "refactoring.guru/solid — last two sections", mins: 25 },
          { type: "YouTube", item: "ArjanCodes – 'Dependency Inversion in Python'", where: "YouTube → search 'arjan codes dependency inversion'", mins: 20 },
        ]},
      ...
      { n: 12, title: "Creational Design Patterns", sessions: [
        { label: "Study", focus: "Factory & Builder", resources: [
          { type: "Article", item: "refactoring.guru – Factory Method + Abstract Factory with Python", where: "refactoring.guru/design-patterns/factory-method", mins: 35 },
      ...
      { n: 13, title: "Structural Design Patterns", sessions: [
        { label: "Study", focus: "Adapter & Decorator", resources: [
          { type: "Article", item: "refactoring.guru – Adapter + Decorator with Python", where: "refactoring.guru/design-patterns/adapter", mins: 35 },
        ...
        { label: "Study", focus: "Proxy & Facade", resources: [
          { type: "Article", item: "refactoring.guru – Proxy + Facade with Python", where: "refactoring.guru/design-patterns/proxy", mins: 30 },
      ...
      { n: 14, title: "Behavioral Design Patterns", sessions: [
        { label: "Study", focus: "Observer & Strategy", resources: [
          { type: "Article", item: "refactoring.guru – Observer + Strategy with Python", where: "refactoring.guru/design-patterns/observer", mins: 35 },
        ...
        { label: "Study", focus: "State & Command", resources: [
          { type: "Article", item: "refactoring.guru – State + Command with Python", where: "refactoring.guru/design-patterns/state", mins: 30 },
    ...
    weeks: [
      { n: 17, title: "pytest Fundamentals & Test Design", sessions: [
        { label: "Study", focus: "pytest basics — test functions, fixtures, conftest.py", resources: [
          { type: "Docs",    item: "pytest Documentation – Getting Started, fixtures, parametrize, conftest.py, markers", where: "docs.pytest.org/en/stable/ — the authoritative guide", mins: 50 },
          { type: "YouTube", item: "ArjanCodes – 'pytest Best Practices'", where: "YouTube → search 'arjan codes pytest best practices'", mins: 25 },
        ]},
        { label: "Study", focus: "Parametrize, coverage & test organization", resources: [
          { type: "Article", item: "Real Python – 'Effective Python Testing with pytest'", where: "realpython.com/pytest-python-testing/ — comprehensive guide", mins: 40 },
          { type: "Docs",    item: "pytest-cov – coverage integration with pytest", where: "pytest-cov.readthedocs.io — add --cov to pytest command", mins: 15 },
        ]},
      ...
      { n: 18, title: "Mocking, TDD & Integration Testing", sessions: [
        { label: "Study", focus: "unittest.mock — Mock, patch, MagicMock", resources: [
          { type: "Docs",    item: "Python unittest.mock — Mock, MagicMock, patch, patch.object, side_effect, assert_called_with", where: "docs.python.org/3/library/unittest.mock.html — the full reference", mins: 40 },
          { type: "YouTube", item: "ArjanCodes – 'Python Mocking'", where: "YouTube → search 'arjan codes python mocking'", mins: 20 },
        ]},
        { label: "Study", focus: "Test-Driven Development — Red → Green → Refactor", resources: [
          { type: "Article", item: "Real Python – 'Getting Started with TDD in Python'", where: "realpython.com/python-tdd-introduction/", mins: 30 },
          { type: "YouTube", item: "ArjanCodes – 'TDD in Python'", where: "YouTube → search 'arjan codes TDD python'", mins: 22 },
        ]},
      ...
      { n: 19, title: "Code Quality — mypy, ruff & CI", sessions: [
        { label: "Study", focus: "mypy type checking — strict mode and common patterns", resources: [
          { type: "Docs",    item: "mypy documentation – Getting Started, configuration, strict mode, protocols", where: "mypy.readthedocs.io/en/stable/ — run mypy --strict on your codebase today", mins: 40 },
          { type: "Article", item: "Real Python – 'Python Type Checking with mypy'", where: "realpython.com/python-type-checking/", mins: 30 },
        ]},
        { label: "Study", focus: "ruff linter + black formatter + pre-commit hooks", resources: [
          { type: "Docs",    item: "ruff documentation – configuration, rules, auto-fix, pyproject.toml", where: "docs.astral.sh/ruff/ — blazing-fast Python linter replacing flake8+isort+more", mins: 25 },
          { type: "YouTube", item: "ArjanCodes – 'Python Code Quality Tools'", where: "YouTube → search 'arjan codes python code quality'", mins: 20 },
        ]},
    ...
    weeks: [
      ...
      { n: 45, title: "CI/CD & Deployment", sessions: [
        ...
        { label: "Study", focus: "Deployment strategies — blue/green, canary", resources: [
          { type: "YouTube", item: "ByteByteGo – 'Blue-Green Deployment vs Canary Deployment'", where: "YouTube → search 'bytebytego blue green canary deployment'", mins: 15 },
